...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!db.Questions.Any())
    {
        var allLevels = db.Levels.OrderBy(l => l.LevelID).ToList();
        int l1 = allLevels.Count > 0 ? allLevels[0].LevelID : 1;
        int l2 = allLevels.Count > 1 ? allLevels[1].LevelID : 2;
        int l3 = allLevels.Count > 2 ? allLevels[2].LevelID : 3;
        int l4 = allLevels.Count > 3 ? allLevels[3].LevelID : 4;

        // --- 40 Questions ---
        var questions = new List<Question>
        {
            // Chặng 1: Cơ Bản (LevelID=1, 10 câu)
            new Question { LevelID = l1, Content = "AI la viet tat cua cum tu nao?",
            ...
            new Question { LevelID = l1, Content = "Cong cu AI nao sau day duoc biet den nhieu nhat de tro chuyen voi nguoi dung?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l1, Content = "Dieu gi xay ra khi ban 'prompt' mot AI chatbot?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l1, Content = "Cong cu nao giup tao hinh anh tu van ban (text-to-image)?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l1, Content = "Google cung cap cong cu AI chatbot nao canh tranh voi ChatGPT?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l1, Content = "LLM trong linh vuc AI la viet tat cua?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l1, Content = "Cong cu AI nao cua Microsoft duoc tich hop vao trinh duyet Edge?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l1, Content = "AI co the lam gi trong linh vuc viet noi dung?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l1, Content = "Dieu nao sau day mo ta dung nhat ve 'hallucination' cua AI?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l1, Content = "Khi su dung AI cho cong viec, dieu quan trong nhat la?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l2, Content = "Ky thuat 'prompt engineering' la gi?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l2, Content = "Khi viet prompt cho AI, de dat ket qua tot nen:",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l2, Content = "Cong cu AI nao phu hop nhat de phan tich du lieu bang bieu va to Excel?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l2, Content = "Chuc nang nao giup AI nho duoc cuoc tro chuyen dai va phan hoi nhat quan?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l2, Content = "Ung dung nao duoi day su dung AI de tao nhac tu van ban?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l2, Content = "De bao ve thong tin bao mat khi dung AI cong ty, ban nen lam gi?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l2, Content = "AI co the ho tro viec dich thuat nhu the nao so voi cong cu truyen thong?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l2, Content = "'Few-shot prompting' co nghia la gi?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l2, Content = "Cong cu nao giup tao video tu van ban (text-to-video)?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l2, Content = "RAG (Retrieval-Augmented Generation) giup AI lam gi?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l3, Content = "Fine-tuning mot mo hinh AI co nghia la gi?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l3, Content = "Token trong cac mo hinh ngon ngu lon la gi?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l3, Content = "Kien truc Transformer trong AI duoc gioi thieu lan dau qua bai bao nao?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l3, Content = "Embeddings trong AI la gi?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l3, Content = "AI Agent khac AI Chatbot o diem nao?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l3, Content = "Temperature trong cac mo hinh AI dieu chinh dieu gi?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l3, Content = "Ky thuat 'Chain-of-Thought prompting' hoat dong nhu the nao?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l3, Content = "Vector database dung de lam gi trong he thong AI?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l3, Content = "Multi-modal AI co kha nang gi dac biet?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l3, Content = "RLHF (Reinforcement Learning from Human Feedback) duoc dung de lam gi?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l4, Content = "MoE (Mixture of Experts) trong kien truc AI hoat dong theo nguyen tac nao?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l4, Content = "GAN (Generative Adversarial Network) bao gom hai thanh phan chinh la gi?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l4, Content = "Khi xay dung he thong AI Agent phuc tap, 'tool calling' (function calling) co vai tro gi?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l4, Content = "Catastrophic forgetting trong AI la hien tuong gi?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l4, Content = "Constitutional AI (CAI) cua Anthropic co y nghia gi?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l4, Content = "Trong huan luyen LLM, 'PEFT' (Parameter-Efficient Fine-Tuning) nhu LoRA giup gi?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l4, Content = "Context window 1 trieu token cua Gemini 1.5 co y nghia thuc tien gi?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l4, Content = "AI Alignment la linh vuc nghien cuu gi?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l4, Content = "Speculative decoding trong suy luan LLM giup gi?",
                Answers = new List<Answer> {
            ...
            new Question { LevelID = l4, Content = "Trong danh gia LLM, 'benchmark' nhu MMLU, HumanEval, HELM duoc dung de lam gi?",
                Answers = new List<Answer> {
